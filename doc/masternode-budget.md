...
FLACOIN now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<flacoin_address\> \<monthly_payment_flacoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ FLACOIN, _12_ times over the course of a year totaling _24000_ FLACOIN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<flacoin_address\> \<monthly_payment_flacoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` FLACOIN.
