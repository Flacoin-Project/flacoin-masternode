...
This mechanism has been integrated into Bitcore-Node-FLACOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FLACOIN-Project/insight-api-flacoin#web-socket-api](https://github.com/FLACOIN-Project/insight-api-flacoin#web-socket-api) 
* API: [https://github.com/FLACOIN-Project/insight-api-flacoin#swifttx-transactions](https://github.com/FLACOIN-Project/insight-api-flacoin#swifttx-transactions) 
...
By default, the Flacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Flacoin Core daemon:
