...
In order to support loading of multiple wallets in flacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is flacoin.cpp.
...
Changes to flacoin.cpp
----------------------
flacoin.cpp is the entry point into flacoin-qt, and as such, will require some minor modifications to provide hooks for
