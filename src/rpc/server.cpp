...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FLACOIN features */
        {"flacoin", "masternode", &masternode, true, true, false},
        {"flacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"flacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"flacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"flacoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"flacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"flacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"flacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"flacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"flacoin", "startmasternode", &startmasternode, true, true, false},
        {"flacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"flacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"flacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"flacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"flacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"flacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"flacoin", "mnbudget", &mnbudget, true, true, false},
        {"flacoin", "preparebudget", &preparebudget, true, true, false},
        {"flacoin", "submitbudget", &submitbudget, true, true, false},
        {"flacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"flacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"flacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"flacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"flacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"flacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"flacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"flacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"flacoin", "mnsync", &mnsync, true, true, false},
        {"flacoin", "spork", &spork, true, true, false},
        {"flacoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzflaseed", &getzflaseed, false, false, true},
        {"zerocoin", "setzflaseed", &setzflaseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfla", &searchdzfla, false, false, true},
        {"zerocoin", "dzflastate", &dzflastate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16900/\n";
}
