...
/**
 * FLACOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzflaseed(const UniValue& params, bool fHelp);
extern UniValue getzflaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfla(const UniValue& params, bool fHelp);
extern UniValue dzflastate(const UniValue& params, bool fHelp);
