                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFLAPathCustom = GetArg("-zflabackuppath", "");
    ...
    if(!strzFLAPathCustom.empty()) {
        ui->wallet_customzflabackuppath->setText(QString::fromStdString(strzFLAPathCustom));
        ui->wallet_customzflabackuppath_label->setVisible(true);
        ui->wallet_customzflabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFLAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Flacoin RPC console.") + "<br>" +
