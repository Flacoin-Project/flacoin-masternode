...
/** Utility functions used by the FLACOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render FLACOIN addresses in monospace font
...
// Parse "flacoin:" URI into recipient object, return true on successful parsing
