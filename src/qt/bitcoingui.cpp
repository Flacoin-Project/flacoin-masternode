                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Flacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFLA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Flacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Flacoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for FLACOIN"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Flacoin Core help message to get a list with possible FLACOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Flacoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FLACOIN network", "", count));
}
...
{
    QString strTitle = tr("Flacoin Core"); // default title
