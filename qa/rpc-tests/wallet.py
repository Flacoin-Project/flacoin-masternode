...
#   c) node1 mines 32 blocks, so now node 0 has 60001fla, node 1 has 4250fla, node2 has none.
#   d) node0 sends 601 fla to node2, in two transactions (301 fla, then 300 fla).
