...
RESOURCES += src/qt/flacoin.qrc src/qt/flacoin_locale.qrc

TRANSLATIONS += src/qt/locale/flacoin_bg.ts \
                src/qt/locale/flacoin_de.ts \
                src/qt/locale/flacoin_en.ts \
                src/qt/locale/flacoin_es.ts \
                src/qt/locale/flacoin_fi.ts \
                src/qt/locale/flacoin_fr.ts \
                src/qt/locale/flacoin_it.ts \
                src/qt/locale/flacoin_ja.ts \
                src/qt/locale/flacoin_pl.ts \
                src/qt/locale/flacoin_pt.ts \
                src/qt/locale/flacoin_ru.ts \
                src/qt/locale/flacoin_sk.ts \
                src/qt/locale/flacoin_sv.ts \
                src/qt/locale/flacoin_vi.ts \
                src/qt/locale/flacoin_zh_CN.ts \
                src/qt/locale/flacoin_zh_TW.ts
